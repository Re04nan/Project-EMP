    ...
    <>
        ...
        <main className="temp2">
            <div id="caixaRegister">
                ...
                { 
                    msg === true && <div className="alert alert-success w-75" role="alert"> Cadastro feito com sucesso </div>
                }
                { 
                    msg === false && <div className="alert alert-danger w-75" role="alert"> Erro ao efetuar cadastro </div>
                }
            </div>
